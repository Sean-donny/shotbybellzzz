    ...
    <footer className="w-full px-5 py-2 z-40 bg-slate-300">
      <ul className="flex justify-between flex-col-reverse sm:flex-row">
        <li className="mt-5 flex justify-center items-end sm:mt-0">
          <span className="font-line-jp text-gray-600 tracking-tight text-base">
            &#169;{getCurrentYear()}
          </span>
        </li>
        <li className="flex justify-center items-end">
          <a
            className="font-line-jp text-black tracking-tight cursor-pointer text-base opacity-80 hover:opacity-30"
          ...
          <a
            className="font-line-jp text-black tracking-tight cursor-pointer text-base ml-6 sm:ml-9 md:ml-12 lg:ml-4 opacity-80 hover:opacity-30"
